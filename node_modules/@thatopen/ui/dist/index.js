...
const Rt = Math.min, X = Math.max, $e = Math.round, ct = (i) => ({
  x: i,
  y: i
}), Us = {
  left: "right",
...
function Gs(i, t, e, s) {
  const n = je(i);
  let r = Ys(J(i), e === "start", s);
  return n && (r = r.map((o) => o + "-" + n), t && (r = r.concat(r.map(si)))), r;
}
function Ce(i) {
...
function nn(i, t, e) {
  ...
  const r = Et(t), o = Dn(t), a = Hn(o), l = J(t), c = r === "y", u = s.x + s.width / 2 - n.width / 2, d = s.y + s.height / 2 - n.height / 2, f = s[a] / 2 - n[a] / 2;
  let p;
  switch (l) {
    case "top":
      p = {
...
async function Vn(i, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = ce(t, i), b = Fn(p), g = a[f ? d === "floating" ? "reference" : "floating" : d], S = Mt(await r.getClippingRect({
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      ...
      if ((e = r.arrow) != null && e.alignmentOffset)
        return {};
      const S = J(n), E = Et(a), x = J(a) === a, $ = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), O = f || (x || !v ? [Ce(a)] : Qs(a)), _ = b !== "none";
      !f && _ && O.push(...Gs(a, v, b, $));
      const I = [a, ...O], D = await Vn(t, g), F = [];
...
function Un(i) {
  const t = Rt(...i.map((r) => r.left)), e = Rt(...i.map((r) => r.top)), s = X(...i.map((r) => r.right)), n = X(...i.map((r) => r.bottom));
  return {
    x: t,
    y: e,
    width: s - t,
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: l,
        y: c
      } = ce(i, t), u = Array.from(await (r.getClientRects == null ? void 0 : r.getClientRects(s.reference)) || []), d = Zs(u), f = Mt(Un(u)), p = Fn(a);
      function b() {
        ...
        if (d.length >= 2) {
          if (Et(e) === "y") {
            const A = d[0], kt = d[d.length - 1], Qt = J(e) === "top", Pt = A.top, W = kt.bottom, Tt = Qt ? A.left : kt.left, nt = Qt ? A.right : kt.right, st = nt - Tt, Q = W - Pt;
            return {
              top: Pt,
              bottom: W,
              left: Tt,
          ...
          const g = J(e) === "left", S = X(...d.map((A) => A.right)), E = Rt(...d.map((A) => A.left)), x = d.filter((A) => g ? A.left === E : A.right === S), $ = x[0].top, O = x[x.length - 1].bottom, _ = E, I = S, D = I - _, F = O - $;
          return {
            top: $,
            bottom: O,
            left: _,
...
async function er(i, t) {
  const {
    ...
    platform: s,
    elements: n
  } = i, r = await (s.isRTL == null ? void 0 : s.isRTL(n.floating)), o = J(e), a = je(e), l = Et(e) === "y", c = ["left", "top"].includes(o) ? -1 : 1, u = r && l ? -1 : 1, d = ce(t, i);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: b
  ...
  return i === void 0 && (i = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: e,
        y: s
      }, u = await Vn(t, l), d = Et(J(n)), f = Nn(d);
      let p = c[f], b = c[d];
      if (r) {
...
function Qn(i) {
  const t = zt(i);
  return He(t) ? i.ownerDocument ? i.ownerDocument.body : i.body : G(t) && ue(t) ? t : Qn(t);
}
function ri(i, t, e) {
  var s;
  ...
  if (r) {
    const a = or(o);
    return t.concat(o, o.visualViewport || [], ue(n) ? n : [], a && e ? ri(a) : []);
  }
  return t.concat(n, ri(n, [], e));
}
function or(i) {
...
function ee(i, t, e, s) {
  ...
  const n = i.getBoundingClientRect(), r = Gn(i);
  let o = ct(1);
  t && (s ? Y(s) && (o = Lt(s)) : o = Lt(i));
  const a = ar(r, e, s) ? Xn(r) : ct(0);
...
function ur(i) {
  ...
  const r = n === "fixed", o = gt(s), a = t ? Jn(t.floating) : !1;
  if (s === o || a && r)
    return e;
  let l = {
    scrollLeft: 0,
  ...
  const u = ct(0), d = G(s);
  if ((d || !d && !r) && ((ut(s) !== "body" || ue(o)) && (l = De(s)), G(s))) {
    const f = ee(s);
...
function Kn(i) {
  return ee(gt(i)).left + De(i).scrollLeft;
}
function dr(i) {
  const t = gt(i), e = De(i), s = i.ownerDocument.body, n = X(t.scrollWidth, t.clientWidth, s.scrollWidth, s.clientWidth), r = X(t.scrollHeight, t.clientHeight, s.scrollHeight, s.clientHeight);
  let o = -e.scrollLeft + Kn(i);
  const a = -e.scrollTop;
  return B(s).direction === "rtl" && (o += X(t.clientWidth, s.clientWidth) - n), {
    width: n,
    height: r,
    x: o,
    y: a
...
function Zn(i, t) {
  const e = zt(i);
  return e === t || !Y(e) || He(e) ? !1 : B(e).position === "fixed" || Zn(e, t);
}
function mr(i, t) {
  const e = t.get(i);
  if (e)
    return e;
  let s = ri(i, [], !1).filter((a) => Y(a) && ut(a) !== "body"), n = null;
  const r = B(i).position === "fixed";
  let o = r ? zt(i) : i;
  for (; Y(o) && !He(o); ) {
    const a = B(o), l = vi(o);
    !l && a.position === "fixed" && (n = null), (r ? !l && !n : !l && a.position === "static" && !!n && ["absolute", "fixed"].includes(n.position) || ue(o) && !l && Zn(i, o)) ? s = s.filter((u) => u !== o) : n = a, o = zt(o);
  }
  return t.set(i, s), s;
}
function br(i) {
  ...
  const o = [...e === "clippingAncestors" ? mr(t, this._c) : [].concat(e), s], a = o[0], l = o.reduce((c, u) => {
    const d = rn(t, u, n);
    return c.top = X(d.top, c.top), c.right = Rt(d.right, c.right), c.bottom = Rt(d.bottom, c.bottom), c.left = X(d.left, c.left), c;
  }, rn(t, a, n));
  return {
...
function ts(i, t) {
  ...
  if (!G(i) || Jn(i))
    return e;
  let s = on(i, t);
  for (; s && nr(s) && B(s).position === "static"; )
    s = on(s, t);
  return s && (ut(s) === "html" || ut(s) === "body" && B(s).position === "static" && !vi(s)) ? e : s || rr(i) || e;
}
const yr = async function(i) {
  const t = this.getOffsetParent || ts, e = this.getDimensions;
  return {
...
const wr = (i) => new rs(typeof i == "string" ? i : i + "", void 0, xi), C = (i, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Cr, defineProperty: Er, getOwnPropertyDescriptor: Sr, getOwnPropertyNames: Ar, getOwnPropertySymbols: Or, getPrototypeOf: kr } = Object, at = globalThis, cn = at.trustedTypes, Pr = cn ? cn.emptyScript : "", Ge = at.reactiveElementPolyfillSupport, Xt = (i, t) => i, Ee = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? Pr : null;
      break;
...
It.elementStyles = [], It.shadowRootOptions = { mode: "open" }, It[Xt("elementProperties")] = /* @__PURE__ */ new Map(), It[Xt("finalized")] = /* @__PURE__ */ new Map(), Ge == null || Ge({ ReactiveElement: It }), (at.reactiveElementVersions ?? (at.reactiveElementVersions = [])).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jt = globalThis, Se = Jt.trustedTypes, hn = Se ? Se.createPolicy("lit-html", { createHTML: (i) => i }) : void 0, os = "$lit$", lt = `lit$${Math.random().toFixed(9).slice(2)}$`, ls = "?" + lt, Tr = `<${ls}>`, St = document, ie = () => St.createComment(""), ne = (i) => i === null || typeof i != "object" && typeof i != "function", $i = Array.isArray, Ir = (i) => $i(i) || typeof (i == null ? void 0 : i[Symbol.iterator]) == "function", Xe = `[ 	
\f\r]`, Yt = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, dn = /-->/g, fn = />/g, xt = RegExp(`>|${Xe}(?:([^\\s"'>=/]+)(${Xe}*=${Xe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), pn = /'/g, mn = /"/g, as = /^(?:script|style|textarea|title)$/i, Lr = (i) => (t, ...e) => ({ _$litType$: i, strings: t, values: e }), m = Lr(1), At = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), bn = /* @__PURE__ */ new WeakMap(), wt = St.createTreeWalker(St, 129);
function cs(i, t) {
...
const Rr = (i, t) => {
  ...
  for (let a = 0; a < e; a++) {
    ...
    for (; f < l.length && (o.lastIndex = f, u = o.exec(l), u !== null); )
      f = o.lastIndex, o === Yt ? u[1] === "!--" ? o = dn : u[1] !== void 0 ? o = fn : u[2] !== void 0 ? (as.test(u[2]) && (n = RegExp("</" + u[2], "g")), o = xt) : u[3] !== void 0 && (o = xt) : o === xt ? u[0] === ">" ? (o = n ?? Yt, d = -1) : u[1] === void 0 ? d = -2 : (d = o.lastIndex - u[2].length, c = u[1], o = u[3] === void 0 ? xt : u[3] === '"' ? mn : pn) : o === mn || o === pn ? o = xt : o === dn || o === fn ? o = Yt : (o = xt, n = void 0);
    const p = o === xt && i[a + 1].startsWith("/>") ? " " : "";
    r += o === Yt ? l + Tr : d >= 0 ? (s.push(c), l.slice(0, d) + os + l.slice(d) + lt + p) : l + lt + (d === -2 ? a : p);
  }
  return [cs(i, r + (i[e] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), s];
};
class se {
        ...
        if (n.hasAttributes())
          for (const d of n.getAttributeNames())
            if (d.endsWith(os)) {
              ...
              l.push({ type: 1, index: r, name: b[2], strings: p, ctor: b[1] === "." ? zr : b[1] === "?" ? Br : b[1] === "@" ? jr : Fe }), n.removeAttribute(d);
            } else
...
function Bt(i, t, e = i, s) {
  var o, a;
  if (t === At)
    return t;
  let n = s !== void 0 ? (o = e._$Co) == null ? void 0 : o[s] : e._$Cl;
  const r = ne(t) ? void 0 : t._$litDirective$;
  return (n == null ? void 0 : n.constructor) !== r && ((a = n == null ? void 0 : n._$AO) == null || a.call(n, !1), r === void 0 ? n = void 0 : (n = new r(i), n._$AT(i, e, s)), s !== void 0 ? (e._$Co ?? (e._$Co = []))[s] = n : e._$Cl = n), n !== void 0 && (t = Bt(i, n._$AS(i, t.values), n, s)), t;
}
class Mr {
  constructor(t, e) {
  ...
  u(t) {
    ...
    for (; l !== void 0; ) {
      if (o === l.index) {
        let c;
        l.type === 2 ? c = new he(r, r.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(r, l.name, l.strings, this, t) : l.type === 6 && (c = new Nr(r, this, t)), this._$AV.push(c), l = s[++a];
      }
...
class he {
  ...
  _$AI(t, e = this) {
    t = Bt(this, t, e), ne(t) ? t === k || t == null || t === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : t !== this._$AH && t !== At && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Ir(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  $(t) {
    var r;
    const { values: e, _$litType$: s } = t, n = typeof s == "number" ? this._$AC(t) : (s.el === void 0 && (s.el = se.createElement(cs(s.h, s.h[0]), this.options)), s);
...
class Fe {
  ...
  _$AI(t, e = this, s, n) {
    ...
    let o = !1;
    if (r === void 0)
      t = Bt(this, t, e, 0), o = !ne(t) || t !== this._$AH && t !== At, o && (this._$AH = t);
    else {
      const a = t;
      let l, c;
      for (t = r[0], l = 0; l < r.length - 1; l++)
        c = Bt(this, a[s + l], e, l), c === At && (c = this._$AH[l]), o || (o = !ne(c) || c !== this._$AH[l]), c === k ? t = k : t !== k && (t += (c ?? "") + r[l + 1]), this._$AH[l] = c;
    }
    o && !n && this.j(t);
  }
  j(t) {
...
const Je = Jt.litHtmlPolyfillSupport;
Je == null || Je(se, he), (Jt.litHtmlVersions ?? (Jt.litHtmlVersions = [])).push("3.2.1");
const jt = (i, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hr = { attribute: !0, type: String, converter: Ee, reflect: !1, hasChanged: wi }, Dr = (i = Hr, t, e) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const us = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, hs = (i) => (...t) => ({ _$litDirective$: i, values: t });
let ds = class {
  constructor(t) {
  }
  get _$AU() {
...
function Vr(i) {
  this._$AN !== void 0 ? (Ae(this), this._$AM = i, fs(this)) : this._$AM = i;
}
...
const qr = (i) => {
  i.type == us.CHILD && (i._$AP ?? (i._$AP = Ur), i._$AQ ?? (i._$AQ = Vr));
};
class Wr extends ds {
  constructor() {
  ...
  _$AT(t, e, s) {
    super._$AT(t, e, s), fs(this), this.isConnected = t._$AU;
  }
  _$AO(t, e = !0) {
    var s, n;
...
const Ze = /* @__PURE__ */ new WeakMap(), Ht = hs(class extends Wr {
  render(i) {
    return k;
  }
  update(i, [t]) {
  ...
  rt(i) {
    if (this.isConnected || (i = void 0), typeof this.Y == "function") {
      ...
      let e = Ze.get(t);
      e === void 0 && (e = /* @__PURE__ */ new WeakMap(), Ze.set(t, e)), e.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), e.set(this.Y, i), i !== void 0 && this.Y.call(this.ht, i);
    } else
      this.Y.value = i;
  }
  get lt() {
    var i, t;
    return typeof this.Y == "function" ? (i = Ze.get(this.ht ?? globalThis)) == null ? void 0 : i.get(this.Y) : (t = this.Y) == null ? void 0 : t.value;
  }
  disconnected() {
...
function vs(i) {
  if (typeof i != "object" || i === null)
    return null;
  const t = i;
  if (typeof t.prefix != "string" || !i.icons || typeof i.icons != "object" || !ti(i, io))
    return null;
  const e = t.icons;
  for (const n in e) {
    const r = e[n];
    if (!n.match(Zt) || typeof r.body != "string" || !ti(
      r,
      oi
    ))
      return null;
  ...
  for (const n in s) {
    ...
    if (!n.match(Zt) || typeof o != "string" || !e[o] && !s[o] || !ti(
      r,
      oi
    ))
      return null;
    ...
    t.forEach((r) => {
      ...
      o.pending = o.pending.filter((l) => {
        ...
        if (i.icons[c])
          ...
          return e = !0, !0;
        return !1;
      }), o.pending.length !== a && (e || xs([i], r.id), r.callback(
        o.loaded.slice(0),
        o.missing.slice(0),
        o.pending.slice(0),
        r.abort
...
const Ve = /* @__PURE__ */ Object.create(null), Gt = [
...
const Cn = "iconify2", le = "iconify", Cs = le + "-count", En = le + "-version", Es = 36e5, go = 168, vo = 50;
function ci(i, t) {
  try {
    return i.getItem(t);
  } catch {
...
function ui(i, t) {
  return Si(i, Cs, t.toString());
}
function hi(i) {
  return parseInt(ci(i, Cs)) || 0;
}
const $t = {
  local: !0,
  session: !0
...
function Os(i, t) {
  ...
  const n = Math.floor(Date.now() / Es) - go, r = (a) => {
...
let Ps = !1;
try {
  Ps = navigator.vendor.indexOf("Apple") === 0;
} catch {
}
function Ao(i, t) {
  switch (t) {
  ...
  return t !== "style" && (Ps || i.indexOf("<a") === -1) ? "svg" : i.indexOf("currentColor") === -1 ? "bg" : "mask";
}
...
function kn(i, t) {
  let e = Array.from(i.childNodes).find((s) => s.hasAttribute && s.hasAttribute(ni));
  e || (e = document.createElement("style"), e.setAttribute(ni, ni), i.appendChild(e)), e.textContent = ":host{display:inline-block;vertical-align:" + (t ? "-0.125em" : "0") + "}span,svg{display:block}" + Ls;
}
function Rs() {
  xn("", Uo), ys(!0);
  let i;
  ...
  return {
    enableCache: (e) => On(e, !0),
    disableCache: (e) => On(e, !1),
    iconLoaded: _n,
    iconExists: _n,
    getIcon: oo,
    listIcons: ro,
...
function Ln(i, t) {
  const e = t.icon.data, s = t.customisations, n = Ts(e, s);
  ...
  const n = [
    ...
    */
    ...
    attributeChangedCallback(l) {
      switch (l) {
        case "inline": {
          const c = ii(this), u = this._state;
          c !== u.inline && (u.inline = c, kn(this._shadowRoot, c));
          break;
        }
        case "observer": {
    ...
    _iconChanged(l) {
      ...
      c.data ? this._gotIconData(c) : this._state = Rn(c, this._state.inline, this._state);
    }
    /**
...
`, vt = {
  ...
  static init() {
    y.addGlobalStyles(), y.defineCustomElement("bim-button", sl), y.defineCustomElement("bim-checkbox", dt), y.defineCustomElement("bim-color-input", K), y.defineCustomElement("bim-context-menu", bi), y.defineCustomElement("bim-dropdown", V), y.defineCustomElement("bim-grid", ae), y.defineCustomElement("bim-icon", gi), y.defineCustomElement("bim-input", Ot), y.defineCustomElement("bim-label", ft), y.defineCustomElement("bim-number-input", L), y.defineCustomElement("bim-option", T), y.defineCustomElement("bim-panel", Z), y.defineCustomElement("bim-panel-section", pt), y.defineCustomElement("bim-selector", mt), y.defineCustomElement("bim-table", M), y.defineCustomElement("bim-tabs", et), y.defineCustomElement("bim-tab", R), y.defineCustomElement("bim-table-cell", Le), y.defineCustomElement("bim-table-children", Re), y.defineCustomElement("bim-table-group", Me), y.defineCustomElement("bim-table-row", tt), y.defineCustomElement("bim-text-input", j), y.defineCustomElement("bim-toolbar", Ft), y.defineCustomElement("bim-toolbar-group", Dt), y.defineCustomElement(
      "bim-toolbar-section",
      bt
    ), y.defineCustomElement("bim-viewport", ze);
  }
  static newRandomId() {
...
class zs extends w {
  ...
  static create(t, e) {
    ...
    let n = e;
    const r = t, o = (c) => (n = { ...n, ...c }, jt(r(n, o), s), n);
    o(e);
    const a = () => n;
...
const Ie = (i, t = {}, e = !0) => {
  ...
  return s;
}, qe = (i) => i === "true" || i === "false" ? i === "true" : i && !isNaN(Number(i)) && i.trim() !== "" ? Number(i) : i, Zo = [">=", "<=", "=", ">", "<", "?", "/", "#"];
function Mn(i) {
  const t = Zo.find(
    (a) => i.split(a).length === 2
  ), e = i.split(t).map((a) => a.trim()), [s, n] = e, r = n.startsWith("'") && n.endsWith("'") ? n.replace(/'/g, "") : qe(n);
...
var tl = Object.defineProperty, el = Object.getOwnPropertyDescriptor, Bs = (i, t, e, s) => {
...
const Pi = (P = class extends w {
  ...
  async updatePosition() {
    if (!(this.visible && this._previousContainer))
      return;
    const t = this.placement ?? "right", e = await ss(this._previousContainer, this, {
      placement: t,
      middleware: [qn(10), ns(), is(), es({ padding: 5 })]
    }), { x: s, y: n } = e;
...
const Ri = class Ri extends w {
  ...
  get value() {
    return this._value !== void 0 ? this._value : this.label ? qe(this.label) : this.label;
  }
  set value(t) {
    this._value = t;
  }
...
var hl = Object.defineProperty, js = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && hl(t, e, n), n;
};
...
let gi = Be;
var dl = Object.defineProperty, We = (i, t, e, s) => {
  for (var n = void 0, r = i.length - 1, o; r >= 0; r--)
    (o = i[r]) && (n = o(t, e, n) || n);
  return n && dl(t, e, n), n;
};
...
const ji = class ji extends w {
  ...
  get value() {
    return this.textContent ? qe(this.textContent) : this.textContent;
  }
  render() {
    return m`
...
var Tl = Object.defineProperty, Il = Object.getOwnPropertyDescriptor, Qe = (i, t, e, s) => {
...
var Ll = Object.defineProperty, Rl = Object.getOwnPropertyDescriptor, Wt = (i, t, e, s) => {
...
var Bl = Object.defineProperty, jl = Object.getOwnPropertyDescriptor, Ns = (i, t, e, s) => {
...
var Nl = Object.defineProperty, Hl = Object.getOwnPropertyDescriptor, Ye = (i, t, e, s) => {
...
var Dl = Object.defineProperty, Fl = Object.getOwnPropertyDescriptor, Ti = (i, t, e, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Hs = "important", ql = " !" + Hs, Xl = hs(class extends ds {
  constructor(i) {
    var t;
    if (super(i), i.type !== us.ATTRIBUTE || i.name !== "style" || ((t = i.strings) == null ? void 0 : t.length) > 2)
