...
import { TableDataTransform, TableGroupData, TableLoadFunction, TableRowData, ColumnData } from "./src";
/**
...
export declare class Table<T extends TableRowData = TableRowData> extends LitElement {
     ...
     */
    get tsv(): string;
    applyDataTransform(data: Partial<T>): Partial<Record<keyof T, import("./src").CellRenderValue>>;
    /**
