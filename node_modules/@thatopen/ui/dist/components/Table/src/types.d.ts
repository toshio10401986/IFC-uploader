 ...
 */
export type TableRowData<T extends Record<string, TableCellValue> = Record<string, TableCellValue>> = Record<keyof T, TableCellValue>;
 ...
 */
export type TableRowTemplate<T extends TableRowData = TableRowData> = Partial<Record<keyof T, CellRenderValue>>;
/**
 ...
 */
export interface TableGroupTemplate<T extends TableRowTemplate = TableRowTemplate> {
    data: T;
 ...
 */
export interface RowDeselectedEventDetail<T extends TableRowData = TableRowData> {
    data: Partial<T>;
}
export type TableLoadFunction<T extends TableRowData = TableRowData> = () => Promise<TableGroupData<T>[]>;
/**
