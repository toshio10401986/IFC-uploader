...
export type UpdateFunction<S extends Record<string, any>> = (state?: Partial<S>) => S;
/**
 ...
 */
export type StatefullComponent<S extends Record<string, any> = Record<string, any>> = (state: S, update: UpdateFunction<S>) => TemplateResult;
/**
